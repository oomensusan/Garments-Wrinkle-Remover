...
def parse_arguments():
    ...
    parser.add_argument("--src_img", type=str, default=None, help="Location of input image")
...
if __name__=="__main__":    
    ...
    diffusion_model.generate(args.src_img, args.n_images_per_row, args.timesteps, args.beta1, args.beta2)
